# Consumer product recall coordinator handoff
...
Name the accountable human owner and where `outputs/consumer-product-recall-coordinator-handoff.md` should be reviewed.
