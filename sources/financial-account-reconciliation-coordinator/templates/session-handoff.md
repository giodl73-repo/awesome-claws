# Financial account reconciliation coordinator handoff
...
Name the accountable human owner and where `outputs/financial-account-reconciliation-coordinator-handoff.md` should be reviewed.
