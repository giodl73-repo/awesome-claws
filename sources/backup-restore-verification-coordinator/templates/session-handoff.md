# Backup Restore Verification Coordinator handoff
...
Name the accountable human owner and where `outputs/backup-restore-verification-coordinator-handoff.md` should be reviewed.
