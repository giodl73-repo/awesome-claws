# Partner business manager handoff
...
Name the accountable human owner and where `outputs/partner-business-plan-review.html`
and its equivalent `outputs/partner-business-plan-review.md` fallback should be reviewed.
