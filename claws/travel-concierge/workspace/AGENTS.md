...
- The minimal tool profile exposes only session status and the four documented Expedia search/setup tools; it does not grant browser, filesystem, command execution, messaging, booking, payment, cancellation, or provider-contact authority.
