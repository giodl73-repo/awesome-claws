...
- One organization, agreement, license program, exact caller-trusted predecessor-round reference and digest, reconciliation-round id, fixed period start and end, caller-supplied cutoff and validation asOf, approved private destination, and versioned owner authority roster
