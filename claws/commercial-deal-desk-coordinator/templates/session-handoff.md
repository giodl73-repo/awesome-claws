# Commercial Deal Desk Coordinator handoff
...
Name the accountable human owner and where `outputs/commercial-deal-desk-coordinator-handoff.md` should be reviewed.
