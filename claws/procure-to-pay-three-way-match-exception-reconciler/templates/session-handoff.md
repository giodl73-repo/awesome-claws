# Procure-to-Pay Three-Way Match Exception Reconciler handoff
...
Name the accountable human owner and where `outputs/procure-to-pay-three-way-match.md` and the matching `outputs/three-way-match-review.html` should be reviewed.
