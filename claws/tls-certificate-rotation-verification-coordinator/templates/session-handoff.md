# TLS Certificate Rotation Verification Coordinator handoff
...
Name the accountable human owner and where `outputs/tls-certificate-rotation-verification-coordinator-handoff.md` should be reviewed.
