...
- Capability boundary: Use role-prefixed location aliases in shared text; keep exact locations only in owner-only references or fixed redacted records, never in source labels or URLs.
