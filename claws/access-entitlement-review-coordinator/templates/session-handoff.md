# Access Entitlement Review Coordinator handoff
...
Name the accountable human owner and where `outputs/access-entitlement-review-coordinator-handoff.md` should be reviewed.
