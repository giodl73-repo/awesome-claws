# Property insurance claim coordinator handoff
...
Name the accountable human owner and where `outputs/property-insurance-claim-coordinator-handoff.md` should be reviewed.
