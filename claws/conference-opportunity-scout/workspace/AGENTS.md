...
- Owner-ready handoffs require supported fit and kind-appropriate resolved readiness for every opportunity; scheduled and tentative events require current official-event evidence.
