...
export const ARTIFACT_SCHEMA_NAMES = Object.freeze({
  ...
  "commercial-deal-desk-coordinator": "commercial-deal-desk.schema.json",
  ...
  "customer-success-program-manager": "customer-success-review.schema.json",
  ...
  "learning-program-manager": "learning-program-release.schema.json",
  "learning-plan-coordinator": "learning-plan.schema.json",
  ...
  "problem-known-error-coordinator": "problem-known-error.schema.json",
  ...
  "rental-housing-coordinator": "rental-housing-ledger.schema.json",
  ...
  "release-coordinator": "release-readiness.schema.json",
