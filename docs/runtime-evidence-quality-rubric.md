...
The current full baseline is the catalog-derived 131 Claws x 3 scenarios =
**393 trials**. The current seven-day soak is 131 Claws x 3 scenarios x 7
repetitions = **2,751 trials**. `--check` derives these counts from the loaded
...
identity for the window and dispatch one 393-trial baseline on each of seven
...
2,751-trial budget can be reviewed before a calendar workflow is enabled. It
