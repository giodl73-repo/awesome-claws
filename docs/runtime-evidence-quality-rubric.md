...
The current full baseline is the catalog-derived 132 Claws x 3 scenarios =
**396 trials**. The current seven-day soak is 132 Claws x 3 scenarios x 7
repetitions = **2,772 trials**. `--check` derives these counts from the loaded
...
identity for the window and dispatch one 396-trial baseline on each of seven
...
2,772-trial budget can be reviewed before a calendar workflow is enabled. It
