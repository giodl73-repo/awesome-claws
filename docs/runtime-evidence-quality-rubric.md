...
The current full baseline is the catalog-derived 119 Claws x 3 scenarios =
**357 trials**. The current seven-day soak is 119 Claws x 3 scenarios x 7
repetitions = **2,499 trials**. `--check` derives these counts from the loaded
...
identity for the window and dispatch one 357-trial baseline on each of seven
...
2,499-trial budget can be reviewed before a calendar workflow is enabled. It
