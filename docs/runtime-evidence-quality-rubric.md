...
The current full baseline is the catalog-derived 125 Claws x 3 scenarios =
**375 trials**. The current seven-day soak is 125 Claws x 3 scenarios x 7
repetitions = **2,625 trials**. `--check` derives these counts from the loaded
...
identity for the window and dispatch one 375-trial baseline on each of seven
...
2,625-trial budget can be reviewed before a calendar workflow is enabled. It
