...
The current full baseline is the catalog-derived 133 Claws x 3 scenarios =
**399 trials**. The current seven-day soak is 133 Claws x 3 scenarios x 7
repetitions = **2,793 trials**. `--check` derives these counts from the loaded
...
identity for the window and dispatch one 399-trial baseline on each of seven
...
2,793-trial budget can be reviewed before a calendar workflow is enabled. It
