...
Awesome Claws has 129 maintained starter Claws. The catalog now covers a broad
...
post-100 prioritization tool. The current baseline has 129 of 129 Claws passing
...
| --- | ---: | --- |
| Retrospective admission records | 118 of 129 | Make legacy distinctness decisions reviewable without reopening accepted admissions |
| Structured artifact schemas | 129 of 129 | Add schemas only where a durable structured decision artifact improves the job |
| Semantic artifact validators | 129 of 129 | Enforce provenance, reconciliation, chronology, and authority invariants beyond JSON shape |
